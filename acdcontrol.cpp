...
const int CINEMA_DISPLAY_20_ALT           = 0x921b;
const int CINEMA_DISPLAY_23_NEW           = 0x921c;
...
const int CINEMA_DISPLAY_30_NEW           = 0x9221;
...
void help( const char *programName ) {
  ...
  printf( "USAGE: %s [--silent|-s] [--brief|-b] [--help|-h] [--about|-a] [--force|-f] "
          ...
          "      Valid brightness ranges depend on the display model.\n"
          "      On the maintainer's tested Apple LED Cinema Display 27\" (A1316),\n"
          "      the effective range is 0..1023.\n"
          "\n"
...
void init_device_database() {
  ...
  supportedDevices.insert( DeviceId( APPLE, CINEMA_DISPLAY_20_ALT,
                                     "Apple Cinema Display 20\" (alt)" ));
  ...
  supportedDevices.insert( DeviceId( APPLE, CINEMA_DISPLAY_30_NEW,
